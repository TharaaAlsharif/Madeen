...
<body>
  ...
  <?php
      ...
      //Get the id value from login page
       ...
       include 'connec.php';
       $query = "SELECT * FROM madeen.creditior WHERE nationalID =$nat2 ";
       $result = $conn->prepare($query);
       $result->execute();
       $info =  $result->fetchAll();
    ?>

<form id="profile" action="updateCreditor.php" method="post">
  <fieldset>
    <div class="forms-row">
      <div class="col-1">
    ...
    <div class="forms-row">
      ...
      <div class="col-2">
        <input type="text" name="username" id="username" value="<?php echo $info[0]['username']; ?>" disabled>
      </div>
    </div>
    <div class="forms-row">
      <div class="col-1">
...
<?php
include 'connec.php';
$stmt = $conn->prepare("SELECT * FROM madeen.order WHERE creditior = $nat2 ");
$stmt->execute();
